...
| [005](./005-twists-submission/) | `twists-submission` | `spec-done` | 002, 003 | 3 endpoints autenticados (`POST/DELETE /twists/*`, `GET /me/twists`), advisory lock para quota race-safe, soft delete sin liberar quota, Idempotency-Key requerido, integración con cycle.state. |
